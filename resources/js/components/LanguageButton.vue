...
export default {
    name: "LanguageButton",
    components: {Menu, MenuButton, MenuItem, MenuItems, ArchiveBoxIcon, ArrowRightCircleIcon, ChevronDownIcon, DocumentDuplicateIcon, HeartIcon, PencilSquareIcon, TrashIcon, UserPlusIcon},
    methods: {
        toggleDarkMode() {
