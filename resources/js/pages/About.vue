                            ...
                            <div class="lg:order-first lg:row-span-2">
                                ...
                                <div class="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
                                    <p>
                                        ...
                                        program when I was 6
                                        years old, just two weeks after my mom brought home the brand new Macintosh LC
                                        550
                                    ...
                                    <p>
                                        ...
                                        and was able to transmit a photo back down to our family computer from
                                        space.
                                    </p>
                                    ...
                                    <li class="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
                                        <a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500"
                                           href="mailto:contact@danielvdspoel.nl">
                                            ...
                                            <span class="ml-4">contact@danielvdspoel.nl</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
